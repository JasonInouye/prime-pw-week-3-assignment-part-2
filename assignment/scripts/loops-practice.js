...
// AFTER COMPLETING 3-C re-did the countdown to 0
for (let i=5; i>=0; i--) {
  if (i >= 1) {
    console.log(i);
  }
...
const max = 5;
while ( i_c < max ){
  console.log( `in while loop. i_c:`, i_c );
  i_c++;
}
...
const max2 = 5;
while ( i_d >= max2 ){
  console.log( `in while loop. i_d:`, i_d );
  i_d--;
}
